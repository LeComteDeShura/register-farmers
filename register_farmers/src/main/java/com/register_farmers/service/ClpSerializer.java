...
import com.register_farmers.model.DistrictClp;
import com.register_farmers.model.FarmerClp;
...
public class ClpSerializer {
        ...
        synchronized (ClpSerializer.class) {
            ...
            try {
                ...
                String portletPropsServletContextName = (String) getMethod.invoke(null,
                        "register_farmers-1.0-SNAPSHOT-deployment-context");
            ...
            if (Validator.isNull(_servletContextName)) {
                _servletContextName = "register_farmers-1.0-SNAPSHOT";
            }
    ...
    public static Object translateOutput(BaseModel<?> oldModel) {
        ...
        if (oldModelClassName.equals(
                    "com.register_farmers.model.impl.DistrictImpl")) {
        ...
        if (oldModelClassName.equals(
                    "com.register_farmers.model.impl.FarmerImpl")) {
    ...
    public static Throwable translateThrowable(Throwable throwable) {
        ...
        if (className.equals("com.register_farmers.NoSuchDistrictException")) {
            return new com.register_farmers.NoSuchDistrictException();
        }

        if (className.equals("com.register_farmers.NoSuchFarmerException")) {
            return new com.register_farmers.NoSuchFarmerException();
        }
